...
$(function () {
    ...
    $('#city-picker-search1').cityPicker({
        dataJson: cityData,
        renderMode: true,
        search: true,
        linkage: false
    });
    $('#city-picker-search2').cityPicker({
        dataJson: cityData,
        renderMode: true,
        search: true,
        linkage: false
...
//		console.log(regk(areacodeArr).substr(1))
//		console.log(regk(areanameArr).substr(1))
...
//      province = $("#userdiv #distpicker select[name='province']").val() || '',
//      city = $("#userdiv #distpicker select[name='city']").val() || '',
//      area = $("#userdiv #distpicker select[name='area']").val() || '',
//      uVIP = $("#userdiv #adduserModal input[name='uVIP']:checked").val() || '';
//      console.log($("#userdiv #uUnitId").val())
...
//      regk(din);
        ...
        faceData.append('expireTime', expireTime);
...
function operateFormatter(value, row, index) {
    if (row.bindType == 0) {
        ...
        return [
            ...
            '<button type="button" data-id="button1" class="pcode update btn-sm btn face-button " style="margin-right:15px;">修改</button>',
            '<button type="button" data-id="button2" class="pcode delete btn-sm btn face-button2" style="margin-right:15px;">删除</button>',
            '<button type="button" disabled class="unbind btn-sm btn face-button" style="margin-right:15px;">未绑定</button>'
        ].join('');
    }
}
...
function userEdit(row) {
    ...
    $("#modifyUserModal #continue").click(function () {
        ...
        faceData.append('file', uploadFile2);
        faceData.append('uName', $("#modifyUserModal #uName").val());
        faceData.append('policeType', $("#modifyUserModal #policeType").val());
        faceData.append('approval', $("#modifyUserModal #approval").val());
        faceData.append('uRealName', $("#modifyUserModal #urealName").val());
        faceData.append('uSex', $("#modifyUserModal input[name='uSex']:checked").val());
        faceData.append('uCardId', $('#modifyUserModal #uCardId').val());
        faceData.append('uStatus', $("#modifyUserModal #uStatus").val());
        faceData.append('uPhone', $("#modifyUserModal #uPhone").val());
        faceData.append('uTelephone', $("#modifyUserModal #uTelephone").val());
        faceData.append('uPolicyNum', $("#modifyUserModal #uPolicyNum").val());
        faceData.append('uDuty', $("#modifyUserModal #uDuty").val());
        faceData.append('uRoleId', $("#modifyUserModal #uRoleId").val());
        faceData.append('uUnitId', $("#modifyUserModal #uunitId").val());
        faceData.append('expireTime', expireTime);
        faceData.append('province', $("#modifyUserModal .province").text());
        faceData.append('city', $("#modifyUserModal .city").text());
        faceData.append('area', $("#modifyUserModal .area").text());
        faceData.append('uVIP', $("#modifyUserModal input[name='uVIP']:checked").val());
        // var data = {
        //    
