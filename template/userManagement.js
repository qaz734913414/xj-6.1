...
$(function() {
  ...
  $('#adduserModal #expireTimeVal').datetimepicker({format: "yyyy-mm-dd", showMeridian: true, autoclose: true, language: 'zh-CN', minView: 2});
  $('#modifyUserModal #expireTimeVal').datetimepicker({format: "yyyy-mm-dd", showMeridian: true, autoclose: true, language: 'zh-CN', minView: 2});
  $('#modifyUserModal #expireTimeVal2').datetimepicker({format: "yyyy-mm-dd", showMeridian: true, autoclose: true, language: 'zh-CN', minView: 2});
  $('#wrenchModal #expireTimeVal').datetimepicker({format: "yyyy-mm-dd", showMeridian: true, autoclose: true, language: 'zh-CN', minView: 2});
...
function userEdit(row) {
  ...
  $("#modifyUserModal #continue").click(function() {
    ...
    faceDatas.append('expireTime', expireTime);
    var areacodeArr = [],
      areanameArr = [];
